...
def main(config):
    ...
    if config.mode == 'train':
        ...
        solver.model.load_state_dict(torch.load('20231009071717checkpoints/checkpoint.pt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='NIPS_TS_Swan')
    parser.add_argument('--data_path', type=str, default='./dataset/kdd/dataset/NIPS_TS_Swan')
